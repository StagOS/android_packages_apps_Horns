...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String HORNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, HORNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, HORNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(HORNS, "interval");
            if(newInterval != null)
