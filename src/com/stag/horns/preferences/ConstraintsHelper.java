...
public class ConstraintsHelper {
    ...
    private static final String LINEAGE_HARDWARE = "lineagehardware:";
    ...
    private boolean checkConstraints() {
        ...
        try {
            ...
            if (rFeature != null) {
                ...
                boolean available = rFeature.startsWith(LINEAGE_HARDWARE) ?
                        LineageHardwareManager.getInstance(mContext).isSupported(
                                rFeature.substring(LINEAGE_HARDWARE.length())) :
