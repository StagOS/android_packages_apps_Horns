...
import com.stag.hornss.preferences.CustomSeekBarPreference;
...
public class BatteryBarSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.horns_statusbar_battery_bar);
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                    ...
                    sir.xmlResId = R.xml.horns_statusbar_battery_bar;
                    result.add(sir);
                    return result;
                }
