package com.stag.settings.preferences;
...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String STAGSETTINGSNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, STAGSETTINGSNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, STAGSETTINGSNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(STAGSETTINGSNS, "interval");
            if(newInterval != null)
